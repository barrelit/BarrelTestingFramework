...
public class TestConfig
	...
	public static String from = "raghavendrad234@gmail.com";
	public static String password = "Sirisha.16";
	public static String[] to ={"raghavendra.damaraju@testingxperts.com"};
